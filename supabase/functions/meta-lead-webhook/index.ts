  ...
  try {
    ...
    for (const entry of body.entry ?? []) {
      ...
      for (const change of entry.changes ?? []) {
        ...
        const formMappingId = formMapping?.id ?? null
            ...
            : [
                {
                  ...
                  meta_question_id: "full_name",
                  meta_question_text: "Full name",
                  target_kind: "standard" as const,
                  target_standard_field: "full_name" as const,
                  target_custom_field_id: null,
                },
                {
                  id: "_fb2",
                  form_mapping_id: formMappingId ?? "",
                  meta_question_id: "email",
                  meta_question_text: "Email",
                  target_kind: "standard" as const,
                  target_standard_field: "email" as const,
                  target_custom_field_id: null,
                },
                {
                  id: "_fb3",
                  form_mapping_id: formMappingId ?? "",
                  meta_question_id: "phone_number",
                  meta_question_text: "Phone",
                  target_kind: "standard" as const,
                  target_standard_field: "phone_number" as const,
                  target_custom_field_id: null,
                },
              ],
          customFields,
