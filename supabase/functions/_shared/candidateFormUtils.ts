 ...
 */
export async function resolveFormFields(supabase: any, applicationId: string, applicantId: string) {
  ...
  return {
    ...
    builtin_columns,
    position: position
      ? { title: position.title, intro_text: position.candidate_form_intro_text }
      : null,
