...
export function renderEmailLayout(options: EmailLayoutOptions): string {
  ...
  const footer = `<tr><td bgcolor="${footerBg}" style="background:${footerBg};background-color:${footerBg};color:${footerText};padding:24px 32px;border-top:1px solid ${FOOTER_THEME.border};font-family:${FONT_STACK};font-size:12px;line-height:1.7;text-align:center;">${footerInner}</td></tr>`;
