...
DROP TRIGGER IF EXISTS send_note_edit_notification_trigger ON public.messages;
DROP FUNCTION IF EXISTS public.send_note_edit_notification();

-- Recreate function with proper privileges
