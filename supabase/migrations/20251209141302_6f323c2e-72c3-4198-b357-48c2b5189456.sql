-- Fix get_conversations to sort by received_at instead of updated_at
...
-- Backfill Joachim Rathke conversation received_at
...
WHERE c.id = 'd8aa5d02-dbb3-4d4f-a4a0-7c2393c5fee5';