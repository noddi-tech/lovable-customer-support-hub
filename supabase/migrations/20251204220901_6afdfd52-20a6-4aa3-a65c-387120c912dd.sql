-- Fix notify_slack_on_new_message to include inbox_id and strip HTML from preview_text
...
BEGIN
  ...
  -- Call Slack notification edge function using correct parameter order: url, body, params, headers
  BEGIN
    PERFORM net.http_post(
      v_supabase_url || '/functions/v1/send-slack-notification',
      jsonb_build_object(
...
-- Fix notify_slack_on_conversation_update to include inbox_id
