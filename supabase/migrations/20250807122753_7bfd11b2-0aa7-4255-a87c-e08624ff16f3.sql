-- Add received_at field to conversations table to store actual email timestamp
ALTER TABLE public.conversations 
ADD COLUMN IF NOT EXISTS received_at TIMESTAMP WITH TIME ZONE;

-- Update conversations to use received_at as the primary sort field, falling back to updated_at
