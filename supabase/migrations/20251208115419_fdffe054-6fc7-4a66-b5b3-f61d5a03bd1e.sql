-- =========================================================
-- CONSOLIDATE get_conversations TO SINGLE FUNCTION
-- =========================================================
-- WARNING: This is the ONLY get_conversations function.
-- DO NOT create overloads. If you need new parameters, 
-- ADD them with defaults, don't create new signatures.
-- =========================================================

-- Drop ALL existing overloads to prevent ambiguity
DROP FUNCTION IF EXISTS public.get_conversations();
DROP FUNCTION IF EXISTS public.get_conversations(uuid, text, integer, integer);
DROP FUNCTION IF EXISTS public.get_conversations(inbox_filter uuid, status_filter text, page_limit integer, page_offset integer);

-- Now recreate the single definitive version (with p_ prefix)
...
-- Add comment to prevent future overloads
COMMENT ON FUNCTION public.get_conversations(uuid, text, text, integer, integer) IS 
'SINGLE DEFINITIVE VERSION - DO NOT CREATE OVERLOADS. Add parameters with defaults if needed.';