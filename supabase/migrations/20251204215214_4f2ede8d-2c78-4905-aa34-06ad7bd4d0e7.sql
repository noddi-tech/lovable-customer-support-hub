-- Fix notify_slack_on_new_message to use correct pg_net.http_post signature (body as jsonb)
...
-- Fix notify_slack_on_conversation_update to use correct pg_net.http_post signature (body as jsonb)
