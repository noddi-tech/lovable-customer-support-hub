    ...
    const probeElements = () => {
      ...
      candidates.forEach((element) => {
        ...
        if (causes.length > 0) {
          ...
          element.setAttribute(
            "style",
            `${element.getAttribute("style") || ""} outline: 2px solid #ef4444 !important; outline-offset: 2px !important;`,
          )
      ...
      if (offenders.length > 0) {
        console.groupCollapsed(
          `🚨 UIProbe: Found ${offenders.length} overlap issues on ${window.location.pathname}`,
        )
