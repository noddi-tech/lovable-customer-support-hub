    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <span
            style={{ fontWeight: 700, fontSize: "13px", color: isSelected ? "#1d4ed8" : "#334155" }}
          >
      ...
      <div style={{ padding: "10px 12px" }}>
        {rows.map((r, i) => (
          ...
          >
            ...
            <span
              style={{ fontWeight: 600, textAlign: "right", maxWidth: "60%", fontSize: "11px" }}
            >
              {r.value}
            </span>
          </div>
...
const BookingSelectBlock: React.FC<BlockComponentProps> = ({
  primaryColor,
  data,
  usedBlocks,
  onAction,
