...
const ConfirmPreview: React.FC<FlowPreviewProps> = () => (
  <div className="rounded-md bg-white dark:bg-background border p-2">
    ...
    <div className="flex gap-1.5">
      <div className="flex-1 flex items-center justify-center gap-1 border-2 border-green-400 rounded-lg py-1 text-green-600 text-[9px] font-semibold">
        ✓ Bekreft
      </div>
      <div className="flex-1 flex items-center justify-center gap-1 border-2 border-red-400 rounded-lg py-1 text-red-600 text-[9px] font-semibold">
        ✕ Avbryt
      </div>
    </div>
  </div>
