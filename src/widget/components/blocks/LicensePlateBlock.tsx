    ...
    <div style={{ margin: "8px 0" }}>
      ...
      <div style={{ display: "flex", gap: "6px", alignItems: "stretch" }}>
        ...
        >
          ...
          <span style={{ fontSize: "10px", color: "#6b7280" }}>{country}</span>
        </button>
...
const LicensePlatePreview: React.FC<FlowPreviewProps> = () => (
  <div className="rounded-md bg-white dark:bg-background border p-2">
    ...
    <div className="flex items-center gap-1.5">
      ...
      <div className="flex-1 border rounded-md px-2 py-1 text-[10px] text-muted-foreground/50 font-mono tracking-wider">
        AB 12345
      </div>
      <div className="bg-primary/80 text-primary-foreground rounded-md px-2 py-1 text-[9px] font-semibold">
        🔍
      </div>
    </div>
  </div>
