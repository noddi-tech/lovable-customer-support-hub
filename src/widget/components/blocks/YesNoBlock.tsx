  ...
  return (
    <div style={{ margin: '10px 0' }}>
      ...
      <div style={{ display: 'flex', gap: '8px' }}>
        <button disabled={isUsed} onClick={() => handleSelect('Ja')}
          style={{
            flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
            padding: '10px 16px', borderRadius: '10px', fontSize: '13px', fontWeight: 600, cursor: isUsed ? 'default' : 'pointer',
            border: '1.5px solid #22c55e',
            background: selected === 'Ja' ? '#22c55e' : 'transparent',
            color: selected === 'Ja' ? '#fff' : '#22c55e',
            opacity: isUsed && selected !== 'Ja' ? 0.4 : 1,
        ...
        <button disabled={isUsed} onClick={() => handleSelect('Nei')}
          style={{
            flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
            padding: '10px 16px', borderRadius: '10px', fontSize: '13px', fontWeight: 600, cursor: isUsed ? 'default' : 'pointer',
            border: '1.5px solid #ef4444',
            background: selected === 'Nei' ? '#ef4444' : 'transparent',
            color: selected === 'Nei' ? '#fff' : '#ef4444',
            opacity: isUsed && selected !== 'Nei' ? 0.4 : 1,
            transition: 'all 0.15s ease',
          }}
        >
