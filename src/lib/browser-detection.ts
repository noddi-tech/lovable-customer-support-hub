...
export const getBrowserInstructions = (type: BrowserType): string[] => {
  const instructions: Record<BrowserType, string[]> = {
    ...
    opera: ["Aircall requires Google Chrome", "Please download and install Chrome"],
    ie: ["Internet Explorer is not supported", "Please download and install Google Chrome"],
    unknown: [
