...
import { Activity, Building2, Crown, MessageSquare, TrendingUp, Users } from "lucide-react"
    ...
    <AdminPortalLayout>
      <div className="min-h-screen bg-gradient-to-br from-yellow-50/30 via-background to-amber-50/20 dark:from-yellow-950/10 dark:via-background dark:to-amber-950/10">
        <div className="container mx-auto p-6 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              {currentOrganizationId
                ? `Organization metrics for ${selectedOrg?.name || "selected org"}`
          ...
          {/* Overview Stats */}
          <div
            className={`grid gap-4 md:grid-cols-2 ${!currentOrganizationId ? "lg:grid-cols-4" : "lg:grid-cols-3"}`}
          >
            {!currentOrganizationId && (
            ...
            <Card className="border-yellow-200 dark:border-yellow-900/50">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {currentOrganizationId ? "Active members" : "Across all organizations"}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-yellow-200 dark:border-yellow-900/50">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {currentOrganizationId ? "In this organization" : "System-wide"}
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Active users / Total users</p>
                  </div>
