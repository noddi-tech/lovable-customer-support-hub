              ...
              <div className="px-3 sm:px-6 pt-3 sm:pt-4 pb-2">
                ...
                {totalUnread > sortedAndFiltered.length && (
                  <p className="mt-2 text-xs text-muted-foreground">
                    Showing the {sortedAndFiltered.length} most recent of {totalUnread} unread
                    notifications.
                  </p>
                )}
                {!isMobile && selectedIds.length > 0 && (
                  <div className="mt-2 flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="h-7"
                      onClick={() => bulkMarkRead(selectedIds, true)}
                    >
                      Mark as read
                    </Button>
                    <Button
                        ...
                        sortedAndFiltered.map((n) => {
                          ...
                          return (
                            <ContextMenu key={n.id}>
                              <ContextMenuTrigger
                                asChild
                                onContextMenu={() => handleContextMenuOpen(n)}
                              >
                                <TableRow
                                  className={cn(
                              ...
                              <ContextMenuContent className="w-56">
                                ...
                                <ContextMenuItem
                                  onSelect={() =>
                                    setSelectedIds(sortedAndFiltered.map((x) => x.id))
                                  }
                                >
