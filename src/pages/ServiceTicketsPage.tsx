...
import { AlertTriangle, CheckCircle, Clock, Tag, Ticket, User } from "lucide-react"
...
const mockServiceTickets = [
  {
    ...
    subtitle:
      "Production database experiencing intermittent connection timeouts • Assigned to: DevOps Team",
  ...
  },
  {
    ...
    subtitle:
      "Multiple users reporting login issues with OAuth providers • Assigned to: Backend Team",
  ...
  },
  {
    ...
    subtitle:
      "Notification emails experiencing 15-minute delays • Assigned to: Infrastructure Team",
...
const mockTicketDetails = {
  ticket1: {
    title: "Database Connection Timeout Issues",
    description:
      "Production database experiencing intermittent connection timeouts affecting user authentication and data retrieval operations.",
    status: "open",
    priority: "urgent",
  ...
  ticket2: {
    title: "User Authentication Failures",
    description:
      "Multiple users reporting inability to log in using OAuth providers (Google, GitHub, Microsoft).",
    status: "in-progress",
    priority: "high",
  ...
  ticket3: {
    title: "Email Delivery Delays",
    description:
      "Notification emails experiencing delays of 10-15 minutes, affecting user experience.",
    status: "resolved",
    priority: "normal",
    ...
    <div className="space-y-2">
      ...
      {mockServiceTickets.map((ticket) => (
        <EntityListRow
          ...
          metadata={[{ label: "Priority", value: ticket.priority }]}
