...
export function useCreateFollowup() {
  ...
  return useMutation({
    ...
    onError: (e: any) =>
      toast({
        title: "Klarte ikke lagre påminnelse",
...
export function useCompleteFollowup() {
  ...
  return useMutation({
    ...
    onError: (e: any) =>
      toast({ title: "Klarte ikke fullføre", description: e.message, variant: "destructive" }),
  })
}
...
export function useSnoozeFollowup() {
  ...
  return useMutation({
    ...
    onError: (e: any) =>
      toast({ title: "Klarte ikke utsette", description: e.message, variant: "destructive" }),
  })
}
...
export function useDeleteFollowup() {
  ...
  return useMutation({
    ...
    onError: (e: any) =>
      toast({ title: "Klarte ikke slette", description: e.message, variant: "destructive" }),
  })
}
