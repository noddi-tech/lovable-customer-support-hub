    ...
    queryFn: async () => {
      ...
      return {
        ...
        durationTrend: calculatePercentageChange(
          todayMetrics.avgDuration,
          yesterdayMetrics.avgDuration,
        ),
        answerRateTrend: calculatePercentageChange(
          todayMetrics.answerRate,
          yesterdayMetrics.answerRate,
        ),
        missedTrend: calculatePercentageChange(
          todayMetrics.missedCalls,
          yesterdayMetrics.missedCalls,
        ),
      }
    },
  })
