      ...
      toast({
        ...
        description: (
          <div className="space-y-1 text-xs">
            <p>
              <kbd>Ctrl+Shift+A</kbd> - Answer call
            </p>
            <p>
              <kbd>Ctrl+Shift+H</kbd> - Hang up
            </p>
            <p>
              <kbd>Ctrl+Shift+M</kbd> - Toggle mute
            </p>
            <p>
              <kbd>Ctrl+Shift+P</kbd> - Toggle hold
            </p>
            <p>
              <kbd>Ctrl+Shift+T</kbd> - Transfer call
            </p>
            <p>
              <kbd>Ctrl+Shift+N</kbd> - Add note
            </p>
            <p>
              <kbd>Ctrl+Shift+?</kbd> - Show this help
            </p>
          </div>
        ),
        duration: 8000,
