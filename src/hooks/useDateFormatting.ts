...
export function useDateFormatting() {
  ...
  const formatters = {
     ...
     */
    relative: (date: Date | string) => formatRelativeTime(date, i18n.language, timezone),
     ...
     */
    time: (date: Date | string) => formatTime(date, i18n.language, timezone, timeFormat === "24h"),
     ...
     * Example: "Jan 15, 2024"
     */
    date: (date: Date | string) => formatDateTime(date, i18n.language, timezone, false),
  }
