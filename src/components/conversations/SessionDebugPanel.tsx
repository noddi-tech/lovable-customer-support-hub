          ...
          <>
            ...
            <div>
              ...
              <div className="bg-muted/30 rounded-lg px-3">
                <CheckItem
                  ok={!!debugInfo.frontend_user}
                  label="User Exists"
                  value={debugInfo.frontend_user?.email}
                />
            ...
            <div>
              ...
              <div className="bg-muted/30 rounded-lg px-3">
                <CheckItem
                  ok={!!debugInfo.db_auth_uid}
                  label="Auth UID"
                  value={debugInfo.db_auth_uid?.slice(0, 8)}
                />
            ...
            <div>
              ...
              <div className="bg-muted/30 rounded-lg px-3">
                <CheckItem
                  ok={!!debugInfo.db_organization_id}
                  label="Org ID"
                  value={debugInfo.db_organization_id?.slice(0, 8)}
                />
              </div>
            </div>
