          ...
          <Popover open={selectOpen} onOpenChange={setSelectOpen}>
                  ...
                  {selectedIds.length === 1 ? (
                    <>
                      <div
                        ...
                        style={{
                          backgroundColor:
                            inboxes.find((i) => i.id === selectedIds[0])?.color || "#6B7280",
                        }}
                      />
                    ...
                    <>
                      ...
                      <OutstandingBadges
                        ...
                        pending={selectedIds.reduce(
                          (s, id) => s + (outstanding[id]?.pending || 0),
                          0,
                        )}
                      />
                    </>
                    ...
                    <>
                      ...
                      <OutstandingBadges
                        open={allOutstanding.open}
                        pending={allOutstanding.pending}
                      />
                    </>
                  )}
            ...
            >
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-2 min-w-0">
                            ...
                            <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-muted-foreground/40" />
              ...
              <p className="px-2 py-1.5 text-[11px] text-muted-foreground border-t border-border mt-1">
                Press 0–9 to switch · tick boxes (or Alt+click / Alt+number) to view several inboxes
                at once
              </p>
            </PopoverContent>
          </Popover>
          ...
          {statusFilters.map((filter) => (
            ...
            >
              <div className="flex items-center gap-2">
                <span className={cn("flex-shrink-0", filter.color)}>{filter.icon}</span>
