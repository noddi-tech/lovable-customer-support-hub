...
import { AlertTriangle, CheckCircle2, CircleDot, Clock, PauseCircle, Timer } from 'lucide-react';
...
const STATUS_STYLES: Record<CaseStatus, string> = {
  ...
  waiting_internal: 'bg-amber-500/10 text-amber-600 border-amber-500/20 dark:text-amber-400',
