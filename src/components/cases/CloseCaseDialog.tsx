...
import { type CaseRecord, useCaseResolutionCodes, useUpdateCase } from "@/hooks/useCases"
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100%-2rem)] max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            A resolution code is required so we can report on why customers contact us and how
            issues end.
          </DialogDescription>
        </DialogHeader>
