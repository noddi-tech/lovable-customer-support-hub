...
import { CaseStatusBadge, CaseSlaBadge } from '@/components/cases/CaseBadges';
...
export function HeaderCaseChip({ conversationId, caseId, className }: HeaderCaseChipProps) {
  ...
  return (
    ...
    >
      ...
      <span className="hidden max-w-[160px] truncate font-medium sm:inline">{linkedCase.title}</span>
