...
import { Clock, Inbox, Loader2, Mail, MessageSquare, User } from "lucide-react"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className="font-medium truncate">
              <HighlightText
                text={result.customer_name || result.customer_email || "Unknown"}
                query={query}
              />
            </span>
            {result.status && (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground line-clamp-2 mt-1">
            <HighlightText
              text={stripHtmlTags(result.content || result.preview || "").substring(0, 200)}
              query={query}
            />
          </p>
          {result.created_at && (
