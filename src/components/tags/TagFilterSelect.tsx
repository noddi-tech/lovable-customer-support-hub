  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent
        align="end"
        className={cn(
          "bg-popover z-50 max-h-72 overflow-y-auto",
          showCreate ? "w-auto p-0" : "w-56",
        )}
      >
        {showCreate ? (
          <TagCreateForm
          ...
          <>
            ...
            >
              <Check
                className={cn("h-3.5 w-3.5", value.length === 0 ? "opacity-100" : "opacity-0")}
              />
              All tags
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            ...
            >
              <Check
                className={cn(
                  "h-3.5 w-3.5",
                  value.includes(UNTAGGED) ? "opacity-100" : "opacity-0",
                )}
              />
              Untagged
            </DropdownMenuItem>
