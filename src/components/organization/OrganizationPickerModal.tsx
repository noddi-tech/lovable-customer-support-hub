    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Choose a service organization you are a member of</DialogDescription>
        </DialogHeader>
        <div className="space-y-3">
          ...
          {options.length === 0 && (
            <p className="text-center text-muted-foreground py-8">
              You don&apos;t have access to any organizations yet. Check your Navio service
