...
const buttonVariants = cva(
  "inline-flex !flex-row !items-center justify-center gap-1.5 !whitespace-nowrap shrink-0 min-w-fit text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0 leading-none",
  {
    variants: {
      variant: {
