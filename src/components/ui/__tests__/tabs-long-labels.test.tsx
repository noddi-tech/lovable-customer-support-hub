    ...
    render(
      <Tabs defaultValue="a">
        <TabsList data-testid="tabs-list" className="flex flex-wrap min-w-0">
          <TabsTrigger value="a" data-testid="t-a">
            📧 Email Integrations
          </TabsTrigger>
          <TabsTrigger value="b" data-testid="t-b">
            📱 SMS & Personalization
          </TabsTrigger>
          <TabsTrigger value="c" data-testid="t-c">
      ...
      <div className="w-[360px]">
        <Tabs defaultValue="settings">
          <TabsList data-testid="narrow-tabs" className="flex flex-wrap min-w-0">
            <TabsTrigger value="settings" data-testid="t-settings">
              ⚙️ Settings
            </TabsTrigger>
            <TabsTrigger value="integrations" data-testid="t-integrations">
              🔗 Integrations
            </TabsTrigger>
            <TabsTrigger value="notifications" data-testid="t-notifications">
              🔔 Notifications
            </TabsTrigger>
          </TabsList>
