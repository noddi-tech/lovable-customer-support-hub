...
export const InboxSidebar: React.FC<InboxSidebarProps> = ({
  ...
  const effectiveInboxId = selectedTab.startsWith("inbox-")
    ...
    : selectedInboxId && selectedInboxId !== "all"
      ? selectedInboxId
      : null
  ...
  const sidebarItems = [
    {
      id: "unread",
      label: t("dashboard.sidebar.unread"),
      icon: Inbox,
      count: conversationCounts.unread || 0,
    },
    {
      id: "pending",
      label: t("dashboard.sidebar.pending"),
      icon: Clock,
      count: conversationCounts.pending || 0,
    },
    {
      id: "closed",
      label: t("dashboard.sidebar.closed"),
      icon: CheckCircle,
      count: conversationCounts.closed || 0,
    },
    {
      id: "assigned",
      label: t("dashboard.sidebar.assignedToMe"),
      icon: Users,
    ...
    },
    {
      ...
      icon: Inbox,
      count: conversationCounts.inbox || 0,
    },
    {
      id: "archived",
      label: t("dashboard.sidebar.archived"),
      icon: Archive,
      count: conversationCounts.archived || 0,
    },
    {
      id: "snoozed",
      label: t("dashboard.sidebar.snoozed"),
      icon: Clock,
      count: conversationCounts.snoozed || 0,
    },
  ]
  ...
  const channelItems = [
    {
      id: "email",
      label: t("dashboard.sidebar.email"),
      icon: Mail,
      count: conversationCounts.email || 0,
      color: "channel-email",
    },
    {
      id: "facebook",
      label: t("dashboard.sidebar.facebook"),
      icon: MessageCircle,
      count: conversationCounts.facebook || 0,
      color: "channel-facebook",
    },
    {
      id: "instagram",
      label: t("dashboard.sidebar.instagram"),
      icon: Camera,
      count: conversationCounts.instagram || 0,
    ...
    },
    {
      ...
      icon: Phone,
      count: conversationCounts.whatsapp || 0,
    ...
    <div className="pane flex flex-col bg-card/90 backdrop-blur-sm shadow-surface">
      ...
      <div className="flex-shrink-0 p-1">
        <NewConversationDialog>
          <Button className="w-full h-6 bg-gradient-primary hover:bg-primary-hover text-primary-foreground shadow-glow text-xs">
      ...
      <div className="pane flex-1 min-h-0">
            ...
            {sidebarItems.map((item) => {
              ...
              return (
                <Button
                  ...
                  variant="ghost"
                  className={cn(
                    "w-full justify-start px-1 py-0.5 h-5 font-normal text-xs",
                    isSelected
                ...
                >
                  <Icon className="mr-1.5 h-2.5 w-2.5" />
                  <span className="flex-1 text-left">{item.label}</span>
                  {item.count > 0 && (
                    <Badge
                      variant={isSelected ? "default" : "secondary"}
                      className="ml-auto h-3 text-xs px-0.5 min-w-0"
                    >
                      {item.count}
                    </Badge>
                  )}
        ...
        <div className="px-0">
          ...
          <div className="space-y-0">
            ...
            >
              <Bell className="mr-1.5 h-2.5 w-2.5" />
              ...
              {channelItems.map((item) => {
                ...
                return (
                  <Button
                    ...
                    onClick={() => onTabChange(item.id)}
                  >
                    <Icon className={cn("mr-1.5 h-2.5 w-2.5", `text-${item.color}`)} />
                    <span className="flex-1 text-left">{item.label}</span>
                    {item.count > 0 && (
                      <Badge
                        variant={isSelected ? "default" : "secondary"}
              ...
              {inboxes
                ...
                .map((inbox) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="mr-1.5 w-2 h-2 rounded-full flex-shrink-0"
