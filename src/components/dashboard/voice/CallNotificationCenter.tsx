...
import { Bell, Check, Phone, PhoneCall, PhoneOff, Voicemail, X } from "lucide-react"
          ...
          <CardContent className="p-0">
            <ScrollArea className="max-h-80">
              {isLoading ? (
                ...
                <div className="p-4 text-center text-muted-foreground">No call notifications</div>
              ) : (
                          ...
                          {notification.data.customer_phone && (
                            <div className="text-xs text-muted-foreground mb-2">
                              ...
                              {notification.data.monitored_line && (
                                <span className="ml-2">→ {notification.data.monitored_line}</span>
                              )}
                            </div>
                          )}
