      ...
      <CallBrandContextMenu callId={call.id} metadata={call.metadata}>
        ...
        >
          ...
          <TableCell className="p-2 w-36">
            <div className="font-mono text-sm">{formatPhoneNumber(call.customer_phone)}</div>
          </TableCell>
          ...
          <TableCell className="p-2 w-28">
            <Badge
              className={cn(
                ...
                statusColors[call.status as keyof typeof statusColors] || statusColors.completed,
              )}
            >
          ...
          {/* Duration */}
          <TableCell className="p-2 w-24">
            <div className="text-sm font-mono">{formatDuration(call.duration_seconds)}</div>
          </TableCell>

          {/* End Reason */}
          <TableCell className="p-2 w-48">
            <div className="text-sm text-muted-foreground truncate">{getEndReason()}</div>
          </TableCell>
