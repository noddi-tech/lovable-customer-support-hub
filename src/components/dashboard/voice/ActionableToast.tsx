import { Calendar, Clock, Phone, PhoneCall, Voicemail } from "lucide-react"
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {type === "missed_call" && onCallBack && (
            <Button size="sm" onClick={onCallBack} className="h-7 text-xs">
          ...
          {type === "voicemail" && onListenNow && (
            <Button size="sm" onClick={onListenNow} className="h-7 text-xs">
          ...
          {onDismiss && (
            <Button size="sm" variant="ghost" onClick={onDismiss} className="h-7 text-xs ml-auto">
              Dismiss
            </Button>
          )}
        </div>
