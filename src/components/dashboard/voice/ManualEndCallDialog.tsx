    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            You are about to manually end this ongoing call. This action is typically used when
            automatic call monitoring has failed.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex items-start gap-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="text-sm">
              ...
              <p className="text-yellow-700 dark:text-yellow-300">
                This will mark the call as ended in the system. Only use this if the automatic call
