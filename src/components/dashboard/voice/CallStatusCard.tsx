...
import { AlertTriangle, Phone, PhoneCall, PhoneIncoming, PhoneOff } from "lucide-react"
      ...
      <CardContent className="space-y-3">
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <EntityTagPicker entityType="call" entityId={call.id} className="justify-end" />
          </div>
        ...
        <div className="flex gap-2 pt-2">
          <CallActionButton phoneNumber={call.customer_phone} size="sm" />
          {onViewDetails && (
            <Button variant="outline" size="sm" onClick={() => onViewDetails(call)}>
              View Details
            </Button>
          )}
          {call.recording_url && (
        ...
        <div className="pt-2 border-t border-border/50">
          <p className="text-[10px] text-muted-foreground/60 font-mono">ID: {call.id}</p>
        </div>
      </CardContent>
