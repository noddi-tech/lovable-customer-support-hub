        ...
        <Tooltip>
          ...
          <TooltipContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              This customer is registered in Noddi
            </p>
          </TooltipContent>
        </Tooltip>
        ...
        {hasBooking && (
          <Tooltip>
            ...
            <TooltipContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Customer has{" "}
                {data.priority_booking_type === "upcoming" ? "an upcoming" : "a recently completed"}{" "}
                booking
              </p>
            </TooltipContent>
          </Tooltip>
        ...
        {unpaidCount > 0 && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge
                variant="outline"
                className="h-5 px-1.5 text-xs border-destructive/50 bg-destructive/5"
              >
            ...
            <TooltipContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Customer has {unpaidCount} unpaid booking{unpaidCount !== 1 ? "s" : ""} requiring
                payment
              </p>
            </TooltipContent>
          </Tooltip>
        ...
        {isPriority && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge
                variant="outline"
                className="h-5 px-1.5 text-xs border-warning/50 bg-warning/5"
              >
