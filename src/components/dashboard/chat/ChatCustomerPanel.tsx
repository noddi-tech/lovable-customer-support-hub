    ...
    try {
      ...
      if (lookupData?.data?.found) {
        ...
        await queryClient.invalidateQueries({
          ...
          predicate: (query) =>
            query.queryKey[0] === "conversation-meta" && query.queryKey[1] === conversationId,
        })
      } else {
        toast({
    ...
    <div className="w-80 border-l flex-shrink-0 overflow-auto bg-background">
      ...
      <div className="p-3 space-y-4">
        ...
        <NoddiCustomerDetails
          ...
          noddiEmail={
            (customer?.metadata as any)?.primary_noddi_email ||
            (customer?.metadata as any)?.alternative_emails?.[0]
          }
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {matchedCustomer.metadata?.unpaid_count > 0 && (
                              <span
                                ...
                                title={`${matchedCustomer.metadata.unpaid_count} unpaid booking(s)`}
                              >
