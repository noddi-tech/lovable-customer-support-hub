...
export const NewsletterBlockRenderer: React.FC<NewsletterBlockRendererProps> = ({
  ...
  const renderBlock = () => {
    switch (block.type) {
      ...
      case "button":
        return (
          <div
            style={{ textAlign: block.styles.textAlign || "left", padding: block.styles.padding }}
          >
            <a
      ...
      case "product":
        return (
          ...
          >
            ...
            <p style={{ margin: "0 0 12px 0", color: "#666" }}>{block.content.description}</p>
  ...
  return <div className="newsletter-block">{renderBlock()}</div>
}
