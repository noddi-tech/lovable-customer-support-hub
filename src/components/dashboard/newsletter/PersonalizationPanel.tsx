import { Building, Calendar, Copy, Mail, Plus, Tag, User } from "lucide-react"
    ...
    <div className="pane">
      <div className="p-4 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{t("personalizationDescription")}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">{t("clickToCopyMergeTag")}</p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">{t("customTagsDescription")}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-xs text-muted-foreground">{t("conditionalContentDescription")}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-xs text-muted-foreground">{t("segmentationDescription")}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <p className="text-blue-700 dark:text-blue-200">{t("personalizationTip1")}</p>
            </div>
            ...
            <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <p className="text-green-700 dark:text-green-200">{t("personalizationTip2")}</p>
            </div>
            ...
            <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              ...
              <p className="text-orange-700 dark:text-orange-200">{t("personalizationTip3")}</p>
            </div>
          </div>
        </div>
      </div>
