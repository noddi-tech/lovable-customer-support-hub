...
export const CONVERSATION_COLUMN_DESCRIPTIONS: Record<string, string> = {
  ...
  customer: 'Who the conversation is with: their name, or the email address if we have no name yet.',
  ...
  waiting: 'How long the customer has been waiting since their last message without a reply from us.',
