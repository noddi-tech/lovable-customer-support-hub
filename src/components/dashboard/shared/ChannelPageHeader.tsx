...
export function ChannelPageHeader({
  ...
  return (
    <div className={cn('flex items-center gap-2 px-3 py-2.5 border-b bg-card sm:px-4 sm:py-3', className)}>
...
export function MetricsButton({ label = 'Metrics', onClick }: { label?: string; onClick: () => void }) {
  return (
