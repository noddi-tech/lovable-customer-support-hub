...
export const InteractionsSidebar: React.FC<InteractionsSidebarProps> = ({
  ...
  const { conversations, channels, notifications, inboxes, loading, error, prefetchData } =
    useOptimizedCounts()
  ...
  return (
    ...
    >
      <SidebarContent className="p-0">
        ...
        {/* Notifications */}
        <SidebarSection title={t("sidebar.notifications", "Notifications")} collapsible={false}>
          <SidebarItem
            icon={Bell}
        ...
        {/* Channels */}
        <SidebarSection title={t("sidebar.channels", "Channels")} defaultExpanded={true}>
        ...
        {/* Inboxes */}
        <SidebarSection title={t("sidebar.inboxes", "Inboxes")} defaultExpanded={true}>
