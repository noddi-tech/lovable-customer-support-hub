import { CheckCircle2, Gauge, Layers, Timer } from "lucide-react"
import { useState } from "react"
import { attainmentTone, MetricTile as Metric } from "@/components/dashboard/MetricTile"
...
export function InboxMetricsDialog({
  open,
  onOpenChange,
  inboxId,
  inboxName,
}: InboxMetricsDialogProps) {
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1">
            ...
            <span className="text-[11px] text-muted-foreground">
              First reply is measured from arrival to the first outgoing agent message; resolution
              from arrival to close.
            </span>
          </div>
        </div>
      )}
