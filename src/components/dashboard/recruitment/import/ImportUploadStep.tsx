...
import { autoDetectMapping, parseFile, type TargetField } from "./parseFile"
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Støtter .csv, .tsv og .xlsx filer</p>
        </div>
        <input
          ref={inputRef}
          type="file"
      ...
      <div className="flex items-start gap-2 text-xs text-muted-foreground">
        ...
        <p>
          Søkere som allerede finnes (samme e-post) hoppes automatisk over. Du får en oversikt før
          import starter.
        </p>
      </div>
    </div>
