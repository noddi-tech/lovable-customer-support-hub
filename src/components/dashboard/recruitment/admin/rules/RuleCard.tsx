...
import { ArrowRight, Copy, GripVertical, MoreVertical, Pencil, Trash2 } from "lucide-react"
...
export function RuleCard({ rule, lookups, onEdit, onRequestDelete }: Props) {
        ...
        <div className="flex-1 min-w-0 py-3 pr-3 space-y-2">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              {!rule.is_active && (
                <span className="text-[10px] italic text-muted-foreground">Inaktiv</span>
              )}
            </div>
            <div className="flex items-center gap-1 shrink-0">
              ...
              <DropdownMenu modal={false}>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" aria-label="Handlinger" className="h-8 w-8">
