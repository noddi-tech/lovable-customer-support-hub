    ...
    <AlertDialog open={open} onOpenChange={(o) => !o && onClose()}>
      <AlertDialogContent className="sm:max-w-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Følgende stadier skal slettes, men har aktive søkere. Velg et mål-stadium for hver slik
            at søkere ikke går tapt.
          </AlertDialogDescription>
        </AlertDialogHeader>
          ...
          {removedStages.map(({ stage, count }) => (
            ...
            >
              ...
              <Select
                ...
                onValueChange={(v) => setAssignments((prev) => ({ ...prev, [stage.id]: v }))}
              >
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction disabled={!allAssigned} onClick={() => onConfirm(assignments)}>
