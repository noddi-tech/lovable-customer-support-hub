...
import { PRESET_COLORS, type Stage, SYSTEM_STAGE_IDS } from "./types"
import {
  useDefaultPipeline,
...
export function PipelineEditor() {
  ...
  const handleDeleteStage = (stage: Stage) => {
    ...
    setDraftStages((prev) =>
      prev.filter((s) => s.id !== stage.id).map((s, i) => ({ ...s, order: i })),
    )
  }
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Dra og slipp for å endre rekkefølgen. Systemstadier (Ikke vurdert, Ansatt,
              Diskvalifisert) kan gis nytt navn og farge, men ikke slettes.
            </p>
          </CardHeader>
