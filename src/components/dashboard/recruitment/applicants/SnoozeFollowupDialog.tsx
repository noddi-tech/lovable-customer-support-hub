      ...
      <DialogContent className="sm:max-w-sm">
        ...
        {!showCustom ? (
          <div className="grid grid-cols-1 gap-2">
            <Button variant="outline" onClick={() => choose(isoOffsetDays(1))}>
              I morgen
            </Button>
            <Button variant="outline" onClick={() => choose(isoOffsetDays(3))}>
              Om 3 dager
            </Button>
            <Button variant="outline" onClick={() => choose(nextMonday())}>
              Neste mandag
            </Button>
          ...
          <div className="space-y-3">
            ...
            <DialogFooter>
              ...
              <Button
                onClick={() => choose(new Date(custom).toISOString())}
