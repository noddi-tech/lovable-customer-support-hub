...
import {
  type MissingField,
  useStageProgressionValidation,
} from "@/hooks/recruitment/useStageProgressionValidation"
...
const StageRequiredFieldsModal: React.FC<Props> = ({
  ...
  }, [open, applicationId, targetStageId, validate.mutate, onProceed, onOpenChange])
