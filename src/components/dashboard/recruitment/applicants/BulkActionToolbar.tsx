    ...
    <div className="sticky top-0 z-10 flex items-center gap-2 flex-wrap p-2 px-3 border rounded-md bg-card shadow-sm">
      ...
      <div className="hidden md:flex items-center gap-1.5 flex-wrap">
        ...
        <TooltipProvider delayDuration={200}>
          <Tooltip>
            ...
            <TooltipContent>
              Be kandidatene fylle ut manglende informasjon via skjema
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      ...
      <div className="md:hidden">
        <DropdownMenu modal={false}>
          <DropdownMenuTrigger asChild>
            <Button size="sm">
              Handlinger <ChevronDown className="h-3 w-3" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end">
            <DropdownMenuItem onSelect={() => openDeferred("move_stage")}>
              Flytt til
            </DropdownMenuItem>
            ...
            <DropdownMenuItem onSelect={() => openDeferred("send_email")}>
              Send e-post
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={() => openDeferred("send_form")}>
              Send skjema
            </DropdownMenuItem>
            ...
            <DropdownMenuItem onSelect={() => openDeferred("export_csv")}>
              Eksporter CSV
            </DropdownMenuItem>
            {isAdmin && (
              <>
