    ...
    >
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button onClick={() => onConfirm(stageId)} disabled={!stageId || loading}>
            Flytt
          </Button>
        </DialogFooter>
      </DialogContent>
    ...
    >
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={() => onConfirm(assigneeId === "__none__" ? null : assigneeId)}
    ...
    >
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={() => onConfirm(templateId, inboxId)}
            disabled={!templateId || !inboxId || loading}
          >
            Send e-post
          </Button>
        </DialogFooter>
          ...
          <div>
            ...
            {(inboxes?.length ?? 0) === 0 && (
              <p className="text-xs text-amber-600 mt-1">
                {channel === "sms"
                  ? "Ingen innboks med SMS aktivert."
                  : "Ingen rekrutterings-innboks."}
              </p>
            )}
          </div>
          <div>
