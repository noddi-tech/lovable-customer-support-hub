...
const SOURCE_MAP: Record<string, { label: string; className: string }> = {
  ...
  finn: {
    label: "Finn.no",
    className: "bg-orange-100 text-orange-800 hover:bg-orange-100 border-transparent",
  },
  website: {
    label: "Nettside",
    className: "bg-purple-100 text-purple-800 hover:bg-purple-100 border-transparent",
  },
  referral: {
    label: "Referanse",
