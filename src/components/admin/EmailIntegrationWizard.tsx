...
import { type SetupType, SetupTypeSelector } from "./wizard/SetupTypeSelector"
...
export function EmailIntegrationWizard({ open, onOpenChange }: EmailIntegrationWizardProps) {
          ...
          <div className="text-right">
            {assignmentMode === "new" && (
              <div className="flex items-center gap-2 justify-end">
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: newInboxColor }} />
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return <SetupTypeSelector selectedType={setupType} onSelectType={setSetupType} />
      case 2:
        if (setupType === "gmail") {
          return (
            <EmailConnectionStep
        ...
        <div className="space-y-6">
          ...
          {currentStep < 4 && showDefaultNavigation && (
            <div className="flex items-center justify-between pt-4 border-t">
              ...
              <Button onClick={handleNext} disabled={!canGoNext() || createInboxMutation.isPending}>
                {getNextButtonLabel()}
