...
describe("AdaptiveSection", () => {
  ...
  describe("Edge Cases", () => {
    ...
    it("handles multiple children", () => {
      ...
      render(<AdaptiveSection data-testid="section">{children}</AdaptiveSection>)
  ...
  describe("Viewport Testing", () => {
    it("behaves consistently across viewport sizes", () => {
      ...
      testViewports.forEach((setViewport, index) => {
        ...
        const { unmount } = render(
          <AdaptiveSection spacing={{ sm: "2", md: "4", lg: "6" }} data-testid={`section-${index}`}>
            <div>Content</div>
          </AdaptiveSection>,
        )
