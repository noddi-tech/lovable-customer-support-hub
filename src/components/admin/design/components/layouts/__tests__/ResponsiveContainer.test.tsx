...
import { createTestChildren, render, screen, setDesktopViewport } from "./test-utils-layouts"
...
describe("ResponsiveContainer", () => {
  ...
  describe("Edge Cases", () => {
    ...
    it("handles multiple children", () => {
      ...
      render(<ResponsiveContainer data-testid="container">{children}</ResponsiveContainer>)
