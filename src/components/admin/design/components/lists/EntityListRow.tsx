  ...
  (
    ...
    const commonProps = {
      ...
      className: cn(
        ...
        // Selected state
        isCurrentlySelected
          ? ["ring-2 ring-ring bg-card border-ring/20", "shadow-sm"]
      ...
      <Component {...buttonProps}>
        ...
        <div className={cn("flex-1 min-w-0 space-y-1", contentClassName)}>
          ...
          <div className="flex items-start justify-between gap-2">
            <h3 className="text-sm font-medium line-clamp-1 text-foreground">{subject}</h3>
                  ...
                  return (
                    ...
                    >
                      {isFromLabel ? (
                        ...
                        <>
                          <span className={cn("font-medium", isWaitingLabel && "font-medium")}>
                            {item.label}:
                          </span>
