...
describe("EntityListRow", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("renders with avatar", () => {
      render(<EntityListRow {...mockProps} avatar={{ fallback: "JS", alt: "John Smith" }} />)
    ...
    it("renders with custom leading element", () => {
      render(<EntityListRow {...mockProps} leading={<div data-testid="custom-icon">Icon</div>} />)
  ...
  describe("Accessibility", () => {
    ...
    it("accepts custom aria-label", () => {
      render(<EntityListRow {...mockProps} aria-label="Custom label" />)
    ...
    it("supports aria-describedby", () => {
      render(<EntityListRow {...mockProps} aria-describedby="description-id" />)
