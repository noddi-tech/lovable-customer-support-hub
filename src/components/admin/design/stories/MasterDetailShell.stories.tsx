        ...
        <CardContent>
          <div className="space-y-4">
            <div className="bg-muted/50 p-4 rounded-lg">
              <p className="text-sm">
                <strong>John Smith:</strong> Hi, I was wondering about the shipping status of my
                recent order. Could you please provide an update?
              </p>
              <p className="text-xs text-muted-foreground mt-2">2 hours ago</p>
            </div>
            <div className="bg-primary/10 p-4 rounded-lg">
              <p className="text-sm">
                <strong>Support:</strong> Hi John! Your order #12345 has been shipped and should
                arrive within 2-3 business days. Here's your tracking number: 1Z999AA1234567890
              </p>
