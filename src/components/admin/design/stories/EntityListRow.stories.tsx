...
export const EmailConversation: Story = {
  args: {
    ...
    preview:
      "Hi, I was wondering about the shipping status of my recent order. Could you please provide an update on when it will arrive?",
    avatar: {
      fallback: "JS",
      alt: "John Smith",
    },
...
export const WithoutPreview: Story = {
  args: {
    ...
    badges: [{ label: "Resolved", variant: "secondary" }],
    meta: [
      ...
      <div className="space-y-2 max-w-md">
        ...
        {conversations.map((conv) => (
          <EntityListRow
            ...
            meta={[{ label: "Updated", value: "2 hours ago" }]}
          />
        ))}
      </div>
    )
