...
export const DataWipeConfirmation = ({
  organizationId,
  organizationName,
}: DataWipeConfirmationProps) => {
    ...
    <Card className="border-destructive">
      ...
      <CardContent className="space-y-6">
        <Alert>
          ...
          <AlertDescription>
            This action is irreversible. All selected data will be permanently deleted from the
            database.
          </AlertDescription>
        </Alert>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setWipeOptions((prev) => ({ ...prev, wipeMessages: checked as boolean }))
              }
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setWipeOptions((prev) => ({ ...prev, wipeConversations: checked as boolean }))
              }
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setWipeOptions((prev) => ({ ...prev, wipeImportJobs: checked as boolean }))
              }
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setWipeOptions((prev) => ({ ...prev, wipeCustomers: checked as boolean }))
              }
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setWipeOptions((prev) => ({ ...prev, wipeInboxes: checked as boolean }))
              }
            />
            <Label htmlFor="wipe-inboxes" className="text-sm font-normal cursor-pointer">
              Delete all inboxes except default ({dataCounts?.inboxes ? dataCounts.inboxes - 1 : 0})
              - ⚠️ Optional
            </Label>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="confirm-text">
            Type <code className="px-2 py-1 bg-muted rounded text-xs">{expectedText}</code> to
            confirm
          </Label>
          <Input
            id="confirm-text"
