  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {isLoading && (
          <div className="text-center py-8 text-muted-foreground">Scanning conversations...</div>
        )}
              ...
              {problematicConversations.map((conv) => (
                ...
                >
                  <div className="flex-1 min-w-0 mr-4">
                    <p className="font-medium truncate">{conv.subject || "No Subject"}</p>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          {conv.message_count.toLocaleString()} messages? This action cannot be
                          undone and will permanently delete all messages.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
