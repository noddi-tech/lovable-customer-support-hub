...
> = {
  super_admin: {
    label: "Super Admin",
    description:
      "Full system access across ALL organizations — inherits all permissions, no additional roles needed",
    color: "bg-yellow-500",
    order: 1,
  },
  admin: {
    label: "Admin",
    description:
      "Organization administrator — can manage users, settings, and inboxes within their organization",
    color: "bg-blue-500",
    order: 2,
  },
  agent: {
    label: "Agent",
    description:
      "Active user — can handle conversations, make calls, reply to emails, and interact with customers",
    color: "bg-green-500",
    order: 3,
  },
  user: {
    label: "User",
    description:
      "View-only access — can see conversations and data but cannot reply or take actions",
    color: "bg-gray-500",
    order: 4,
  },
}
              ...
              <CardContent className="py-3">
                <div className="flex gap-2">
                  ...
                  <div className="text-xs text-yellow-700 dark:text-yellow-400">
                    ...
                    <p>
                      They have full access to all features across all organizations. Additional
              ...
              <CardContent className="py-3">
                <div className="flex gap-2">
                  ...
                  <div className="text-xs text-amber-600 dark:text-amber-500">
                    ...
                    <p>
                      This role grants full system access including all organizations and sensitive
                      data.
                    </p>
                  </div>
                </div>
