      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              This will move all conversations from the source inbox to the target inbox. This
        ...
        <div className="border-t pt-6 space-y-4">
              ...
              <SelectContent>
                {inboxes.map((inbox) => (
                  <SelectItem
                    key={inbox.id}
                    value={inbox.id}
                    disabled={inbox.conversation_count > 0}
                  >
                    {inbox.name} ({inbox.conversation_count} conversations)
          ...
          {inboxForDeletion && inboxForDeletion.conversation_count > 0 && (
            <Alert variant="destructive">
              <AlertTriangle className="h-4 w-4" />
              <AlertDescription>
                Cannot delete "{inboxForDeletion.name}" - it has{" "}
                {inboxForDeletion.conversation_count} conversations. Move them first.
              </AlertDescription>
            </Alert>
          )}
          ...
          <Button
            ...
            disabled={
              !inboxToDelete || isDeleting || (inboxForDeletion?.conversation_count || 0) > 0
            }
            variant="destructive"
            className="w-full"
          >
