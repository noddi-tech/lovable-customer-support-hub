...
export function InboxAssignmentStep({
  ...
  }, [newInboxName, assignmentMode, onNewInboxSenderDisplayNameChange, newInboxSenderDisplayName])
  ...
  return (
    <div className="space-y-6">
      ...
      <RadioGroup
        ...
        onValueChange={(value) => onAssignmentModeChange(value as "existing" | "new" | "skip")}
      >
        {/* Existing Inbox */}
            ...
            <div className="ml-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  How this inbox appears in email "From:" field (e.g., "Noddi Support"
                  &lt;support@noddi.no&gt;)
                </p>
              </div>
        ...
        <div className="space-y-3">
          ...
          {assignmentMode === "skip" && (
            <Alert className="ml-6">
              ...
              <AlertDescription>
                Emails won't sync until you assign this integration to an inbox in Admin →
                Integrations
              </AlertDescription>
            </Alert>
          )}
