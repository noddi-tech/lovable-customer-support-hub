import { AlertCircle, CheckCircle2, Copy, Mail, Send } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="border rounded-lg p-6 space-y-4 bg-muted/30">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              {inboxColor && (
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: inboxColor }} />
              )}
      ...
      {assignmentMode === "skip" && (
        <Alert>
          ...
          <AlertDescription>
            Remember to assign this integration to an inbox from Admin → Integrations before emails
            will be synced.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="flex gap-3 pt-4">
        ...
        <Button
          ...
          variant="outline"
          className={assignmentMode === "skip" ? "w-full" : "flex-1"}
        >
