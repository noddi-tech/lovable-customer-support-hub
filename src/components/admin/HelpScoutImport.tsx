...
export const HelpScoutImport = () => {
  ...
  const handleStartImport = () => {
    ...
    const unmappedMailboxes = mailboxes.filter(
      (mb) => !mailboxMapping[mb.id] || mailboxMapping[mb.id] === "skip",
    )
    ...
    try {
      ...
      if (data.status === "started" && data.jobId) {
        ...
        toast({
          ...
          description:
            "HelpScout data import is running in the background. Progress will update automatically.",
        })
    ...
    <div className="space-y-6">
      ...
      <ImportChecklist
        items={[
          ...
          },
          {
            ...
            status:
              currentStep === "mapping" || currentStep === "importing" ? "completed" : "pending",
          },
          {
            id: "5",
            label: "Start import",
      ...
      <Card className="bg-gradient-surface border-border/50 shadow-surface">
        <CardHeader>
          ...
          <CardDescription>Import your historical conversation data from HelpScout</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <strong> HELPSCOUT_APP_ID</strong> and <strong>HELPSCOUT_APP_SECRET</strong> with
              valid credentials from your HelpScout developer console.
            </AlertDescription>
          </Alert>
          ...
          {currentStep === "mapping" && (
            <div className="space-y-6">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={createAllAsNew} variant="outline" size="sm" className="flex-1">
              ...
              <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  Map each HelpScout mailbox to a target inbox in your organization. You can create
                  new inboxes or skip mailboxes you don't want to import.
                </AlertDescription>
              </Alert>
                          ...
                          >
                            <SelectTrigger
                              className={cn(
                                ...
                                mailboxMapping[mailbox.id] &&
                                  mailboxMapping[mailbox.id] !== "skip" &&
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            ...
            <li>
              ...
              <code className="bg-muted px-1 py-0.5 rounded">
                https://qgfaycwsangsqzpveoup.lovable.app
              </code>
            </li>
