...
import { getWidgetTranslations, SUPPORTED_WIDGET_LANGUAGES } from "@/widget/translations"
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        Customize greeting, response time, and dismissal message for each language. Leave empty to
      ...
      <div className="space-y-4 p-4 rounded-lg border bg-muted/30">
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">Default: {t.defaultGreeting}</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">Default: {t.defaultResponseTime}</p>
        </div>
      ...
      {Object.keys(greetingTranslations).length > 0 ||
      Object.keys(responseTimeTranslations).length > 0 ||
      Object.keys(dismissalMessageTranslations).length > 0 ? (
