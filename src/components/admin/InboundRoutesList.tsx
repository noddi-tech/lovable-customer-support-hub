  ...
  return (
    <Card className="bg-gradient-surface border-border/50 shadow-surface">
      <CardHeader>
        ...
        <CardDescription>
          Receiving addresses connected to your inboxes. Forward your public emails to these.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {routesQuery.isLoading || inboxesQuery.isLoading ? (
          ...
          <div className="space-y-2">
            {routesQuery.data.map((r) => (
              <div
                key={r.id}
                className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 rounded-md border border-border/50 p-3 bg-background/50"
              >
                <div className="space-y-1">
                  <button
                    type="button"
                    className="font-mono text-sm text-left hover:underline focus:underline focus:outline-none"
                    onClick={() => {
                      setSelectedRoute(r)
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    size="sm"
                    type="button"
                    onClick={() => copy(r.address, r.id)}
                  >
                    <Copy className="w-4 h-4 mr-1" />{" "}
                    {copiedId === r.id ? "Copied" : "Copy address"}
                  </Button>
                  <Button
                    variant="ghost"
                    size="sm"
          ...
          <div className="text-sm text-muted-foreground">
            No inbound addresses yet. Create one below.
          </div>
        )}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <a href="#sendgrid-setup" className="inline-flex">
        ...
        >
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>
                Forward your public email to the parse address to deliver into this inbox.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Example: {selectedRoute.alias_local_part}@
                    {(selectedRoute.address.split("@")[1] || "").split(".").slice(1).join(".")}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <code className="font-mono text-sm px-2 py-1 rounded bg-muted/50">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      Create or use the public address above in your email provider (e.g., Google
                      Workspace).
                    </li>
                    <li>Set up forwarding from the public address to the parse address.</li>
                    <li>
                      For Google Groups: add the parse address as a member and allow external
                      senders.
                    </li>
                    <li>
                      Send a test email to the public address; it should appear in the linked inbox.
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a href="#google-group-setup" className="inline-flex">
