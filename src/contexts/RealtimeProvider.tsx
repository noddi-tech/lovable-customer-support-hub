...
} from "@/hooks/useSimpleRealtimeSubscriptions"
...
export const RealtimeProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const wasDisconnected =
      previousStatusRef.current === "disconnected" || previousStatusRef.current === "error"
  ...
  return (
    <RealtimeContext.Provider
      value={{ isConnected, connectionStatus, forceReconnect: memoizedForceReconnect }}
    >
      {children}
    </RealtimeContext.Provider>
  )
