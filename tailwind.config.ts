		...
		extend: {
			colors: {
				...
				inbox: {
					...
					selected: 'hsl(var(--inbox-selected))',
					hover: 'hsl(var(--inbox-hover))'
				},
				channel: {
			...
			keyframes: {
				...
				'confetti-fall': {
					...
					'50%': { opacity: '1', transform: 'translateY(40px) rotate(180deg) scale(1)' },
			...
			animation: {
				...
				'confetti-fall': 'confetti-fall 2s ease-in-out infinite',
